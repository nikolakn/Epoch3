...
public class AddEventActivity extends Activity implements DialogInterface.OnDismissListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	String color_array[]={"#33b5e5","#aa66cc","#99cc00","#ffbb33","#ff4444"
    			,"#0099cc","#9933cc","#669900","#ff8800","#cc0000","#ffffff"
    			,"#eeeeee","#cccccc","#888888"};
		...
		save.setOnClickListener(new View.OnClickListener() {
		    ...
		    public void onClick(View v) {
			   	 try{
				        ...
				        DateTime.parse(date.getText().toString()+" "+time.getText().toString(), DateTimeFormat.forPattern(pattern));
